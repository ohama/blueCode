...
- [x] **HARNESS-01**: `bench/eval-qwen35-122b.sh` audited; macOS bash-strict-mode patterns codified into `documentation/howto/` — COMPLETE 2026-04-29 (28-01 commits `94d905c` + `280677a`)
  ...
  - **Validation:** `documentation/howto/macos-bash-strict-mode-patterns.md` exists; each of the 4 patterns has its own section with symptom/cause/fix; commit refs to `a6159c4` (mkdir-before-tee; corrected from earlier draft `4bcd8a4` which does not exist in this repo), `9f8e06e`, etc.
