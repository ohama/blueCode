...
let duRoundTripTests = testList "LlmPipeline.du-roundtrip (LLM-04)" [

    testCase "MessageRole round-trips through jsonOptions (proves JsonFSharpConverter registered)" <| fun () ->
        ...
        Expect.equal roundTripped original
        ...
        Expect.isFalse (serialized.Contains("\"Case\""))
